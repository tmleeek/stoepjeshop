...
class PayNL_Clickandbuy_Model_Api_Clickandbuy extends Varien_Object
{
    const     MIN_TRANS_AMOUNT = 10;   // 0.10 euro
    const     MAX_TRANS_AMOUNT = 1000000; // 10000.00 euro
    const     PAY_PAYMENT_PROFILE_ID = 139; // 139 = clickandbuy
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('payment/clickandbuy_clickandbuy/'.$key);
