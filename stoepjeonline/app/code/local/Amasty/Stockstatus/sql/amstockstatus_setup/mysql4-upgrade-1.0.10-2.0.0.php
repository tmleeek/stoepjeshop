...
*/
$installer->addAttribute('catalog_product', 'custom_stock_status_quantity_based', array(
    'type'              => 'int',
    'backend'           => '',
    'frontend'          => '',
...
$attributeId = $installer->getAttributeId('catalog_product', 'custom_stock_status_quantity_based');
