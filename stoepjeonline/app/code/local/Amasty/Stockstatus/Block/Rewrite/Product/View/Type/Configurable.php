...
* @copyright Amasty.
*/
class Amasty_Stockstatus_Block_Rewrite_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable
{
    protected $_options;
    ...
    public function getAllowProducts()
    {
        if (!$this->hasAllowProducts()) {
            ...
            foreach ($allProducts as $product) {
                /**
                * Should show all products, but not allow "out of stock" to be added to cart
                */
