<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Drecommbv_Commercebug><active>true</active><codePool>local</codePool></Drecommbv_Commercebug></modules></config>';
			$string = str_replace('Drecommbv_', $this->namespace . '_',$string);
