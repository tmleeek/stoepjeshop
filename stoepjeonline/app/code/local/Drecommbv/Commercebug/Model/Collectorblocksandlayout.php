<?php 
	class Drecommbv_Commercebug_Model_Collectorblocksandlayout extends Drecommbv_Commercebug_Model_Observingcollector
	{
		...
		{		
			...
			foreach($this->_blocks as $block)
			{
				...
				if(strpos($class,'Drecommbv_Commercebug') === 0)
				{
					continue;
				}
			...
			$json->design_paths = Mage::getModel('commercebug/designpathinfo')->getData();
			return $json;
		}
