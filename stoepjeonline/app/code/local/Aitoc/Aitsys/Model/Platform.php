...
**/            
    ...
    public function getLicenseDir( $base = false )
    {
        if (!$this->_licenseDir)
        {
            $this->_licenseDir = dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))).'/var/ait_install/';
...
//            $defaultInstallDir = $this->getInstallDir(true);
            ...
            /* @var $location DOMElement */
            $location->setAttribute('domain',$this->tool()->getRealBaseUrl());
            $location->setAttribute('path',$this->_getLocationPath());
