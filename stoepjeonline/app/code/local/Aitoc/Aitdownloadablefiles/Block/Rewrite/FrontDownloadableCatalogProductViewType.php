 ...
 * File path:   app/code/local/Aitoc/Aitdownloadablefiles/Block/Rewrite/FrontDownloadableCatalogProductViewType.php
 * Copyright:   (c) 2011 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitdownloadablefiles')){ CUUDsYapMrRiaPUW('b9558ad7ac8624760222e57ecdfc2bba'); ?><?php
/**
