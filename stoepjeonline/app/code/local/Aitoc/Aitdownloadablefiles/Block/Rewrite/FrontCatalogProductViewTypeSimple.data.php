 ...
 * File path:   app/code/local/Aitoc/Aitdownloadablefiles/Block/Rewrite/FrontCatalogProductViewTypeSimple.data.php
 * Copyright:   (c) 2011 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitdownloadablefiles')){ pCCBsSjwkDIqjrCk('c1673fd612ffbf4dc5eb347ad7b5c193'); ?><?php
/**
 * @copyright  Copyright (c) 2010 AITOC, Inc. 
 */

class Aitoc_Aitdownloadablefiles_Block_Rewrite_FrontCatalogProductViewTypeSimple extends Mage_Catalog_Block_Product_View_Type_Simple
{
