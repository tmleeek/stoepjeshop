 ...
 */
class AW_Zblocks_Block_Adminhtml_Zblocks_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    protected function getCategoryIds()
    {
        ...
        return $id ? array_unique(explode(',', Mage::getModel('zblocks/zblocks')->load($id)->getCategoryIds())) : array();
    }
