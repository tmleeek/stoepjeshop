...
class AW_Advancedreports_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getOptions()
    {
        ...
        return array_merge($options, $this->getCustomizedLabels());;
    }
    ...
    public function getCustomizedLabels()
    {
        $result = array();
