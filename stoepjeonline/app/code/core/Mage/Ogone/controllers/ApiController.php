...
/**
* BUGFIX
* @link http://www.magentocommerce.com/boards/viewthread/218544/
...
*/
	...
	foreach ($params as $key => $val) {
		if (strlen($val) > 0 && in_array(strtoupper($key), $allowed)) {
			$secretSet .= strtoupper($key) . '=' . $val . $secretCode;
		}
	}
	return $secretSet;
/* BUGFIX END */
