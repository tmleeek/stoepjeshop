    ...
    $bn1jc.fn.extend({
        ...
        reload: function() {
            if (this.tail !== null && this.inTail) {
                this.list.css(this.lt, $bn1jc.intval(this.list.css(this.lt)) + this.tail);
            }
         ...
         */
        add: function(i, s) {
            var e = this.get(i), old = 0, n = $bn1(s);

            if (e.length === 0) {
                var c, j = $bn1jc.intval(i);
                e = this.create(i);
                while (true) {
                    c = this.get(--j);
                    if (j <= 0 || c.length) {
            ...
            if (i > 0 && i < this.first) {
                this.list.css(this.lt, $bn1jc.intval(this.list.css(this.lt)) - wh + 'px');
            }

            this.list.css(this.wh, $bn1jc.intval(this.list.css(this.wh)) + wh + 'px');
        ...
        remove: function(i) {
            ...
            if (i < this.first) {
                this.list.css(this.lt, $bn1jc.intval(this.list.css(this.lt)) + d + 'px');
            }

            e.remove();

            this.list.css(this.wh, $bn1jc.intval(this.list.css(this.wh)) - d + 'px');
        },
        ...
        pos: function(i, fv) {
            ...
            if (l > 0) {
                ...
                if (back) {
                    pos -= l;
                    this.list.css(this.lt, $bn1jc.intval(this.list.css(this.lt)) - l + 'px');
                }
            }
